...
- Removed local machine-specific paths from runnable scripts.
- Expanded ignore rules for Python caches, virtual environments, build artifacts, and generated data outputs.
